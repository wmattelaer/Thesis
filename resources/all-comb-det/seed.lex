...
the other :- N/N : (lambda $0:<e,t> $0)
a :- N/N : (lambda $0:<e,t> $0)
an :- N/N : (lambda $0:<e,t> $0)
another :- N/N : (lambda $0:<e,t> $0)
...
move :- ((S/NP)/PP)/NP : (lambda $3:e (lambda $2:e (lambda $1:e (lambda $0:e (and:<t*,t> (action:<evt,<act,<ent,t>>> $0 move-drop:act $3) (destination:<evt,<rel,<ent,t>>> $0 $2 $1))))))

move :- S/NP : (lambda $1:e (lambda $0:e (action:<evt,<act,<ent,t>>> $0 move-drop:act $1)))

to the :- (S\S)/NP/PP : (lambda $3:e (lambda $2:e (lambda $1:<e,t> (lambda $0:e (and:<t*,t> ($1 $0) (destination:<evt,<rel,<ent,t>>> $0 $3 $2))))))


move :- (((S/NP)/PP)/NP)/NP : (lambda $3:e (lambda $4:e (lambda $2:e (lambda $1:e (lambda $0:e (and:<t*,t> (action:<evt,<act,<ent,t>>> $0 move-drop:act $3) (destination:<evt,<rel,<ent,<me,t>>>> $0 $2 $1 $4)))))))

move :- ((S/PP)/NP)/NP : (lambda $3:e (lambda $2:e (lambda $1:e (lambda $0:e (and:<t*,t> (action:<evt,<act,<ent,t>>> $0 move-drop:act $3) (destination:<evt,<rel,<me,t>>> $0 $1 $2))))))
