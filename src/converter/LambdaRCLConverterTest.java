...
public class LambdaRCLConverterTest {
	...
	public void test1() {
		...
		AbstractRCLExpression expectedExpr = RCLCreator.createFromString(rcl);
		LambdaRCLConverter converter = new LambdaRCLConverter(LogicalExpression.parse(lambda));
		AbstractRCLExpression expr = converter.convert();
